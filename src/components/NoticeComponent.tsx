        ...
        <section>
          ...
          <ul className="list-disc pl-5 text-gray-700 leading-relaxed space-y-3 text-sm">
            <li>
              ...
              sometimes take time to be successful. The payment to the
              beneficiary will be done only after success has been received from
              the payment gateway.
            </li>
            <li>
              Transactions may take a few minutes to process. Please do not{" "}
              <span className="font-semibold">refresh or navigate away</span>{" "}
              from the payment page.
            </li>
            <li>
              We use a secure{" "}
              <span className="font-semibold">third-party payment gateway</span>{" "}
              to process your transaction. By proceeding, you agree to their
        ...
        <section>
          ...
          <ul className="list-disc pl-5 text-gray-700 leading-relaxed space-y-3 text-md">
            <li>
              ...
              लेन-देन सफल होने में कभी-कभी समय लग सकता है। भुगतान लाभार्थी को
              तभी किया जाएगा जब भुगतान गेटवे से सफलता प्राप्त हो जाती है।
            </li>
            <li>
            ...
            <li>
              ...
              <span className="font-semibold">तीसरे पक्ष के भुगतान गेटवे</span>{" "}
              का उपयोग करते हैं। आगे बढ़ने पर, आप उनके नियमों और शर्तों से सहमत
              होते हैं।
            </li>
            <li>
              सफल भुगतान यह गारंटी नहीं देता कि सेवा/उत्पाद डिलीवरी{" "}
              <span className="font-semibold">गलत विवरण प्रदान किए जाने</span>{" "}
              पर होगी।
            </li>
            <li>
              आपके भुगतान विवरण{" "}
